...
//		retrieveTable();
	...
	public static void createTable() throws IOException
	{
		...
		try {
			 HBaseConfiguration hc = new HBaseConfiguration(new Configuration());
			  ...
			  HTableDescriptor ht = new HTableDescriptor("group8"); 
	...
	public static void insertTable() throws IOException{
		...
		config.clear();
         ...
         String latitude="",longitude="",Date="",x="",y="",z="",humidity="",pressure="";
         

		  HTable table = new HTable(config, "group8");
        ...
        BufferedReader br = null;
 		...
 		try {
 			...
 			br = new BufferedReader(new FileReader("C:/Users/sindhu/Desktop//sensorsin4.txt"));
 			...
 			while ((sCurrentLine = br.readLine()) != null) {
 				...
 				p.add(Bytes.toBytes("pressure"), Bytes.toBytes("col"+(count+6)),Bytes.toBytes(pressure));
